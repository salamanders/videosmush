...
val outputVideoFile2 = File("output2.mkv")
...
suspend fun main2() {
    ...
    smush2(allSources, script)
}

@OptIn(ExperimentalCoroutinesApi::class)
suspend fun smush2(allSources: List<Source>, script: Map<Int, Int>) {
    outputVideoFile2.delete()
    var averagingImage: AveragingImage3? = null
    var currentFrame = 0
    ...
    allSources.map {
        ...
        .reduce { acc, flow ->
            ...
            val localAveragingImage =
                averagingImage ?: AveragingImage3.blankOf(frame.imageWidth, frame.imageHeight).also {
        ...
        }.collectToFileLossless(outputVideoFile2)
}
